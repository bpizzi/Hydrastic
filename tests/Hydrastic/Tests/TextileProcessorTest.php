...
class TextileProcessorTest extends PHPUnit_Framework_TestCase
{
	...
	public function testRender()
	{
		...
		$this->assertTag($matcher1, $post->getContent(), 'Textile processor properly parse markdown formatted text (italic).');
		$this->assertTag($matcher2, $post->getContent(), 'Textile processor properly parse markdown formatted text (strong).');
